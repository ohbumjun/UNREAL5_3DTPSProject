...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_HostButtonClicked_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// Delegate Callbacks => UFUNCTION Macro Necessary \n" },
		{ "ModuleRelativePath", "Public/Menu.h" },
		{ "ToolTip", "Delegate Callbacks => UFUNCTION Macro Necessary" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMenu_HostButtonClicked, "HostButtonClicked" }, // 1551656642
		...
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 1304998595
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMenu_Statics::NewProp_HostButton_MetaData[] = {
		{ "BindWidget", "" },
		{ "Comment", "// Button Widget On Our Blueprint Will Be Bound To Variable In Our C++ Class\n// (Cautious : Name Must Be Same)\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Menu.h" },
		{ "ToolTip", "Button Widget On Our Blueprint Will Be Bound To Variable In Our C++ Class\n(Cautious : Name Must Be Same)" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_BlasterMultiplayer_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BlasterMultiplayer_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 1701885131U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BlasterMultiplayer_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_245124373(TEXT("/Script/MultiplayerSessions"),
		Z_CompiledInDeferFile_FID_BlasterMultiplayer_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_BlasterMultiplayer_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
