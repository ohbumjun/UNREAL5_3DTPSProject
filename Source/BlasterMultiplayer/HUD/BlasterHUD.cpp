...
void ABlasterHUD::DrawHUD()
{
	...
	if (GEngine)
	{
		...
		if (m_HUDPackage.CrosshairsCenter)
		{
			...
			DrawCrosshair(m_HUDPackage.CrosshairsCenter, ViewportCenter, Spread);
		}
		...
		if (m_HUDPackage.CrosshairsLeft)
		{
			...
			DrawCrosshair(m_HUDPackage.CrosshairsLeft, ViewportCenter, Spread);
		}
		...
		if (m_HUDPackage.CrosshairsRight)
		{
			...
			DrawCrosshair(m_HUDPackage.CrosshairsRight, ViewportCenter, Spread);
		}
		...
		if (m_HUDPackage.CrosshairsTop)
		{
			...
			DrawCrosshair(m_HUDPackage.CrosshairsTop, ViewportCenter, Spread);
		}
		...
		if (m_HUDPackage.CrosshairsBottom)
		{
			...
			DrawCrosshair(m_HUDPackage.CrosshairsBottom, ViewportCenter, Spread);
		}
	}
}
